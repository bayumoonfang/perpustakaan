...
function db_prefix()
{
	return env('DB_PREFIX', 'tbl_');
}
function db_master_prefix()
{
	// return env('DB_MASTER_PREFIX', 'tbl_');
}
function session_prefix()
{
	return defined('APP_SESSION_PREFIX') ? APP_SESSION_PREFIX : 'sess_ci3_library_';
}
/*
|--------------------------------------------------------------------------
| Index File
...
|
*/
$config['encryption_key'] = '91cdd6eaa26991b8398145682d456dc3';
...
$config['sess_cookie_name'] = APP_SESSION_PREFIX . 'session';
...
$config['csrf_token_name'] = APP_CRSF_PREFIX . 'csrf_token';
$config['csrf_cookie_name'] = APP_CRSF_PREFIX . 'csrf_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array('api.*+', 'panel/book/ajax/search', 'panel/book/ajax/issue', 'panel/buku-barcode-generate', 'panel/book/ajax/proses-kembali', 'post-guest');
