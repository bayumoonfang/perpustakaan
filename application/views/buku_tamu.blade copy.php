						...
						<div class="col-lg-8 col-xl-8 col-xxl-8">
							<div class="pxp-sign-hero-form-content">
								...
								<form method="POST" action="{{site_url('post-buku-tamu')}}" class="mt-4">
									...
									<div class="mb-3">
										<textarea name="description" required class="form-control" id="pxp-company-about" placeholder="Keperluan" style="height: 100px;"></textarea>
									</div>
									...
									<div id="button_guest" data-url={{site_url()}} data-library={{$lib_id}}>
									</div>
								</form>
								<hr />
								<div id="button_catalog" data-url={{site_url()}} data-library={{$lib_id}}>
								</div>
							</div>
						</div>
					</div>
