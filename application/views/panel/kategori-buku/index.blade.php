	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						@if (user_can('add kategori buku'))
							<div class="col-12 text-right mb-4">
								<a href="{{admin_url('kategori-buku/new')}}" class="btn btn-success ml-2">Tambah Data</a>
							</div>
						@endif
						{{show_status()}}
						<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tr>
									...
									@if (user_can(['edit kategori buku','delete kategori buku']))
													...
													<div class="dropdown">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
															@if (user_can('edit kategori buku'))
																<a class="dropdown-item" href="{{admin_url("kategori-buku/$item->id/edit")}}">Edit</a>
															@endif
