			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-auto">
											<div class="row">
												...
												<div class="col-md-auto">
													<a href="{{admin_url("transaksi/buku-masuk")}}" class="btn btn-danger btn-block ml-2">Reset</a>
												</div>
											</div>
										</div>
									</div>
						...
						@if (user_can('add transaksi buku masuk'))
							<div class="col-12 text-right mb-4">
								<a href="{{admin_url('transaksi/buku-masuk/new')}}" class="btn btn-success ml-2">Tambah Data</a>
							</div>
						@endif
						</div>
						{{show_status()}}
						<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
								...
								<tr>
									...
									@if (user_can(['edit transaksi buku masuk','delete transaksi buku masuk']))
										<th width="15%" class="text-center">Action</th>
									@endif
								</tr>
								</thead>
								<tbody>
									@foreach ($buku_masuk as $item)
										<tr>
												...
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
															@if (user_can('edit transaksi buku masuk'))
																<a class="dropdown-item" href="{{admin_url("transaksi/buku-masuk/$item->id/edit")}}">Edit</a>
															@endif
															@if (user_can('delete transaksi buku masuk'))
