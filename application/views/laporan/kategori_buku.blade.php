                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <form action="{{ admin_url('laporan/kategori-buku/cetak') }}" method="GET">
        ...
        <div class="modal fade filter" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <form action="{{ admin_url('laporan/kategori-buku') }}" method="GET" id="filterForm">
