									...
									<div class="row">
										...
										<div class="col-auto">
											<div class="row">
												...
												<div class="col-md-auto">
													<a href="{{admin_url("laporan/peminjaman")}}" class="btn btn-danger btn-block ml-2">Reset</a>
												</div>
											</div>
										</div>
									</div>
										...
										<tr>
											...
											<td>
												<ul style="list-style-type: none;padding-left:0">
													...
													<li>Kembali: <span class="text-success">{{$item->status!=='pinjam' ? $item->return_date: '-'}}</span></li>
												</ul>
											</td>
