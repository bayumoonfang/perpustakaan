(function($) {
    ...
    $('[name=pilih]').on('change', function() {
        var checkedValue = $('[name=pilih]:checked').attr('data-period');

        if (checkedValue == 'da') {
            $('.pxp-plans-price-de').hide();
            $('.pxp-plans-price-da').show();
        } else {
            $('.pxp-plans-price-da').hide();
            $('.pxp-plans-price-de').show();
        }
    });
    $('[name=pilihort]').on('change', function() {
        var checkedValue = $('[name=pilihort]:checked').attr('data-period');

        if (checkedValue == 'ort') {
            $('.pxp-plans-price-ora').hide();
            $('.pxp-plans-price-ort').show();
        } else {
            $('.pxp-plans-price-ort').hide();
            $('.pxp-plans-price-ora').show();
        }
    });
